/*******************************************************************************
 * @file      k044avt.hpp
 * @brief     Wrapper C++ RAII para a biblioteca libK044AVT.so
 ...
 *
 * @details
 * Fornece a classe avanttec::Display 
 */
...
public:
    ...
    /** Lê 176 bytes da EEPROM */
    std::vector<uint8_t> readEEPROM() {
        std::vector<uint8_t> buf(176);
    ...
    /* =====================================================================
     * KeyEcho — exibição de teclas no display 
     * ===================================================================== */
