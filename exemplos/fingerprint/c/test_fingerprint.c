...
{
    printf("\n===== Módulo de Impressão Digital (K044AVT) — teste em C (API de alto nível) =====\n");
...
int main(void)
{
    printf("test_fingerprint — exemplo do módulo de digital via libK044AVT %s (C, API de alto nível, com teclado ativo)\n",
           k044_version());
    fflush(stdout);
