...
public class FingerDemo extends JFrame {
    ...
    private void toggleConnect() {
        ...
        /* verifica status dos dispositivos do teclado */
    ...
    /** Espera o dedo e gera o template no buffer indicado   */
    /**           — até CAPTURE_MAX_ATTEMPTS tentativas.     */    
    ...
    /* Identificação manual equivalente a "Buscar no banco" */
    ...
    /* Repete captura+busca ate' 3 tentativas  */
