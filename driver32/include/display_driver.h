 ...
 * @brief     API pública da biblioteca libK044AVT.so
...
#define K044_SC_KPENTER    0xE05A  /**< Enter do bloco numerico (scancode estendido, AUX) */
...
/**
 * Grava um dos padrões pré-definidos (ver K044_CGRAM_PRESET_*) no
 * slot da CGRAM (0-7) 
 *
 ...
 * interpretar códigos de controle. Usar esta
...
/**
 * Inicia scroll contínuo em uma linha do display.
...
/* =========================================================================
 * Controle do PIN pad (FUTURA IMPLEMENTACAO)
 * ========================================================================= */
...
/**
 * Lê 100 bytes da EEPROM do dispositivo 
...
/**
 * Grava tabela completa MAKE ou BREAK na EEPROM .
 *
...
/**
 * Grava tabela de scan codes na EEPROM .
 *
...
/**
 * Para a thread interna de eventos (timeout de 2s).
 *
 * @return K044_OK em sucesso.
 */
 ...
 *
 * Cria um dispositivo de entrada virtual com todas as teclas do TEC44
...
/**
 * Captura imagem da impressão digital .
...
/**
 * Compara dois templates nos CharBuffers .
...
/**
 * Mescla templates dos CharBuffers em um modelo .
...
/**
 * Armazena modelo no banco de dados .
 *
...
/**
 * Carrega modelo do banco de dados para CharBuffer.
 *
...
/**
 * Remove template(s) do banco de dados.
 *
...
/**
 * Retorna o número de templates válidos no banco.
 *
...
/**
 * Apaga o LED do sensor.
 *
 * @return K044_OK em sucesso.
 */
int k044_fp_led_off_fast(void);

int k044_fp_led_on_fast(void);
int k044_fp_led_flashing_fast(void);
int k044_fp_led_breathing_fast(void);

/**
 * Lê a página de informações do módulo .
...
/** Cores de k044_fp_led_config() — bitmask 
 *  3 bits: bit0=azul, bit1=verde, bit2=vermelho. */
...
/**
 * Controla o LED do sensor de digital .
 *
...
/**
 * Retorna o último confirmation code.
 *
